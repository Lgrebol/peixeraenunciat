...
public class PeixeraGame extends ApplicationAdapter {
     ...
     * @param nMeduses quantitat de meduses que es volen crear
     */
    public PeixeraGame(int nPeixos, int nTaurons, int nMeduses) {
        this.nPeixos = nPeixos;
        this.nTaurons = nTaurons;
        this.nMeduses = nMeduses;
    }
    //</editor-fold>
    ...
    public void create() {
        ...
        PeixeraUtils.crearMedusa(peixera, nMeduses);
    ...
    private void drawPeix(Peix peix) {
        ...
        if (peix.getBody() == null) {
            ...
            }else if (peix instanceof MedusaMascle) {
                sprite = new Sprite(TextureFiles.MEDUSA_M_TEXTURE[peix.getDireccio().ordinal()]);
            }
    ...
    private void drawSprite(Sprite sprite, Peix peix) {
        ...
        if (peix instanceof PeixMascle) {
            ...
            sprite.setTexture(TextureFiles.MEDUSA_M_TEXTURE[peix.getDireccio().ordinal()]);
        }
        sprite.draw(batch);
    }
